...
export function NewSignup() {
  ...
  const handleApprove = async (transaction: any) => {
    ...
    const betTransactions = [
      {
        id: "001",
        mobile_number: "9948293521",
        date: "2025-03-30",
        status: "Pending",
      },
      {
        id: "002",
        mobile_number: "9932332258",
        date: "2025-03-30",
        status: "Pending",
      },
      {
        id: "003",
        mobile_number: "9123123123",
        date: "2025-03-30",
        status: "Pending",
      },
      {
      ...
      <Table>
        <TableHeader>
          <TableRow>
            ...
            <TableHead className="text-center">New User Mobile #</TableHead>
        ...
        {filteredTransactions.map((betTransactions) => (
            <TableRow key={betTransactions.id}>
              ...
              <TableCell className="text-center">{betTransactions.mobile_number}</TableCell>
